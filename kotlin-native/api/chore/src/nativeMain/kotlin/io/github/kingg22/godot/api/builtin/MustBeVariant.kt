...
/**
 * Marks a type must be _variant type_ compatible.
 *
 ...
 *
 * [Kotlin String][String] is not a variant type, can be converted to `Variant` of `GodotString` with `Variant.Type.STRING`.
 * [Unit] is not a variant type, can be converted to `Variant` of `null` with `Variant.Type.NIL`.
 */
@Retention(BINARY)
