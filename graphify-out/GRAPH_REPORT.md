...
2. `at()` - 27 edges
3. `KDocFormatterTest` - 22 edges
4. `Revisión de Startup/Initialization GDExtension (Godot Java)` - 16 edges
5. `EnumeratorShortenerTest` - 15 edges
6. `BridgeContext` - 15 edges
7. `Kogot Binding Philosophy` - 15 edges
8. `Arquitectura KSP Processor para Kogot Bindings` - 15 edges
9. `Guía de Compatibilidad Backward & Forward` - 14 edges
10. `SignalParamFactoryTest` - 14 edges

## Surprising Connections (you probably didn't know these)
- `toClassInfo()` --calls--> `ClassInfo`  [INFERRED]
  processor/src/main/kotlin/io/github/kingg22/kogot/processor/bridge/KspAnalysisContext.kt → analysis/src/main/kotlin/io/github/kingg22/kogot/analysis/models/ClassInfo.kt
- `toAnnotationInfo()` --calls--> `AnnotationInfo`  [INFERRED]
  processor/src/main/kotlin/io/github/kingg22/kogot/processor/bridge/KspAnalysisContext.kt → analysis/src/main/kotlin/io/github/kingg22/kogot/analysis/models/AnnotationInfo.kt
- `toPropertyInfo()` --calls--> `PropertyInfo`  [INFERRED]
  processor/src/main/kotlin/io/github/kingg22/kogot/processor/bridge/KspAnalysisContext.kt → analysis/src/main/kotlin/io/github/kingg22/kogot/analysis/models/PropertyInfo.kt
- `toFunctionInfo()` --calls--> `ParameterInfo`  [INFERRED]
  processor/src/main/kotlin/io/github/kingg22/kogot/processor/bridge/KspAnalysisContext.kt → analysis/src/main/kotlin/io/github/kingg22/kogot/analysis/models/ParameterInfo.kt
...
Cohesion: 0.06
Nodes (17): getLineNumber(), GodotBuiltinTypeNames, KspAnalysisContext, toAnnotationInfo(), toClassInfo(), toFunctionInfo(), toPropertyInfo(), toTypeInfo() (+9 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (44): API Filters, API Module, Architecture Overview, Build Tasks, Changing Godot Version, CLI Tools, code:block1 (┌───────────────────────────────────────────┐), code:bash (java -jar codegen-cli-java-ffm.jar \) (+36 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (27): adaptParameter(), bothVariants(), buildOverloads(), buildOverloadsForConstructor(), buildOverloadsForMethod(), buildWrappedArgs(), constructorWithMappedParams(), delegateCall() (+19 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (11): EnumMask, of(), or(), toEnumMask(), bootstrap(), BridgeLifecycleTest, shutdown(), ExcludeTypesRule (+3 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (15): DiagnosticLocation, GeneratedFile, GeneratedOutput, Generator, GeneratorContext, GeneratorOptions, JsonGenerator, GodotBindingGenerator (+7 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (41): 1. **GenericBuiltinInterceptor.kt** ✅ (NUEVO), 2. **NativeBuiltinClassGenerator.kt** ✅ (MODIFICADO), 3. **TypeAliasGenerator.kt** ✅ (NUEVO), 4. **NativePackageRegistry** ✅ (PARCHE), 5. **KotlinNativeImplGenerator** ✅ (PARCHE), Archivos a Modificar en el Proyecto Real:, 📦 Archivos Creados/Modificados, Archivos Nuevos: (+33 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (38): 🧠 1. Problema real (bien definido), 🔹 1. Signals son strings en Godot, 🧱 2. Núcleo del diseño, 🔹 2. Orden importa, 🧩 3. DSL para nombres de parámetros, 🔹 3. Registro ocurre antes de instancias, 🔹 4. Threading, 🏗️ 4. Top-level factory functions (+30 more)
...
Cohesion: 0.05
Nodes (36): API de Variant funcional, Aquí ocurre:, 🧠 Arquitectura sugerida para tu binding, 🧱 Cómo funciona Godot internamente (versión ultra simplificada), code:gdscript (class MyNode extends Node), code:kotlin (_myNode.myMethod()), code:kotlin (@Export var speed = 10), code:block4 (1. Class registration) (+28 more)
...
Cohesion: 0.06
Nodes (32): 1. Casting fallido (SpriteBench.kt línea 33, 64), 2. GodotString API sucia, 3. Callable placeholder (Utils.kt línea 22-25), 4. Signal connect/disconnect no implementan callable real, Callable System (FastFunctionBridging.swift), Casting System (Wrapped.swift, getOrInitSwiftObject), code:kotlin (// PROBLEMA: Crea Texture2D sin verificar que el objeto Godo), code:kotlin (// CustomSignalClass.kt) (+24 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (31): Cantidades encontradas, ⭐ Class registration, ClassDB registration, code:block1 ([*] Nombre — tipo, read/write/both — doc — necesario), code:block2 (*GDExtensionClassCreationInfo — struct, both — Describe cómo), code:block3 (GDExtensionCallError — struct, both — Describe errores de ll), code:block4 (*GDExtensionVariantType — enum, both — Tipos de Variant — NE), code:block5 (*GDExtensionVariantCallFunc — write — Llama método dinámico) (+23 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (4): SignalParameterDescriptor, SignalParameterDescriptorTest, param(), SignalParamFactoryTest

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (29): 10) Comparacion con JVM (Java/Kotlin), 11) Como llegan los callbacks de clase a Rust (sin reflexion), 12) Cambio de comportamiento en editor y ToolClassesOnly, 1) Registro como GDExtension (entrypoint y `.gdextension`), 2) Inicialización y niveles de carga, 3) Cómo se genera el código de la API GDExtension, 4) Cómo se integra el binario Rust en el entorno de Godot, 5) Resumen operacional (+21 more)
...
Cohesion: 0.14
Nodes (27): at(), getBoolean(), getBuiltin(), getByte(), getDouble(), getFloat(), getInt(), getLong() (+19 more)

### Community 20 - "Community 20"
Cohesion: 0.22
Nodes (26): cleanup_jvm(), godot_java_bridge_init(), initialize_jvm(), append_classpath_entry(), build_classpath_from_dir(), cache_bridge_metadata(), call_java_shutdown(), check_and_clear_java_exception() (+18 more)
...
Cohesion: 0.17
Nodes (12): 🧷 2. HANDLE (puntero opaco), code:block10 (C pointer → Long), code:kotlin (@JvmInline), code:kotlin (value class UninitializedHandle(val ptr: Long)), code:block8 (void* a algo interno de Godot), code:block9 (GDExtensionStringNamePtr), Const handle, Mapeo recomendado (+4 more)

### Community 50 - "Community 50"
Cohesion: 0.17
Nodes (12): 1. Infrastructure Layer, 2. Analysis Layer (`analysis/` module, KSP-agnostic), 3. Validation Layer, 4. Transformation Layer, 5. Generation Layer, code:block3 (processor/src/main/kotlin/io/github/kingg22/kogot/processor/), code:block4 (analysis/src/main/kotlin/io/github/kingg22/kogot/analysis/), code:block5 (processor/src/main/kotlin/io/github/kingg22/kogot/processor/) (+4 more)
...
Cohesion: 0.22
Nodes (7): ClassDBBridge, ClassDefinition, ClassEntry, create(), InstanceHandle, MethodHandler, GDExtensionClassCreationInfo5()

### Community 54 - "Community 54"
Cohesion: 0.18
Nodes (5): AnnotationExtractor, ClassExtractor, FunctionExtractor, PropertyExtractor, TypeExtractor

### Community 55 - "Community 55"
Cohesion: 0.18
Nodes (10): Apply the plugin, Available tasks, code:kotlin (// settings.gradle.kts), code:kotlin (// build.gradle.kts), code:kotlin (jextract {), DSL reference, Features, jextract-gradle-plugin (+2 more)
...
Cohesion: 0.25
Nodes (7): BuiltinClass, BuiltinClassConstant, BuiltinClassMember, BuiltinEnum, BuiltinMethod, Constructor, Operator

### Community 72 - "Community 72"
Cohesion: 0.25
Nodes (7): ApiItem, BuiltinClass, EngineClass, GlobalEnum, NativeStructure, NestedEnum, UtilityFunction
