...
public final class GDExtensionInterfacePackedFloat64ArrayOperatorIndex {
    ...
    private GDExtensionInterfacePackedFloat64ArrayOperatorIndex() {
    ...
    private static final MethodHandle UP$MH =
            FFMUtils.upcallHandle(GDExtensionInterfacePackedFloat64ArrayOperatorIndex.Function.class, "apply", $DESC);
