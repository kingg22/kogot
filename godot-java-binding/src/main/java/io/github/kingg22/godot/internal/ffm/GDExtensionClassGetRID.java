...
public final class GDExtensionClassGetRID {
     ...
     */
    public static MemorySegment allocate(GDExtensionClassGetRID.Function fi, Arena arena) {
    ...
    public static long invoke(MemorySegment funcPtr, MemorySegment p_instance) {
        try {
            return (long) DOWN$MH.invokeExact(funcPtr, p_instance);
