...
public final class GDExtensionCallableCustomLessThan {
    ...
    private static final MethodHandle UP$MH = FFMUtils.upcallHandle(GDExtensionCallableCustomLessThan.Function.class, $DESC);
     ...
     */
    public static byte invoke(MemorySegment funcPtr, MemorySegment callable_userdata_a, MemorySegment callable_userdata_b) {
        try {
