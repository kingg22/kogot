...
public final class GDExtensionClassFreeInstance {
    ...
    public interface Function {
        void apply(MemorySegment p_class_userdata, MemorySegment p_instance);
    }
     ...
     */
    public static MemorySegment allocate(GDExtensionClassFreeInstance.Function fi, Arena arena) {
    ...
    public static void invoke(MemorySegment funcPtr, MemorySegment p_class_userdata, MemorySegment p_instance) {
        try {
            DOWN$MH.invokeExact(funcPtr, p_class_userdata, p_instance);
