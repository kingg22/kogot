...
/// ```
public final class ClassCreateInstance2 {

    private ClassCreateInstance2() {
    ...
    private static final MethodHandle UP$MH = upcallHandle(ClassCreateInstance2.Function.class, $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}. The lifetime of the returned segment
     * is managed by {@code arena}
     */
    public static MemorySegment allocate(ClassCreateInstance2.Function fi, Arena arena) {
