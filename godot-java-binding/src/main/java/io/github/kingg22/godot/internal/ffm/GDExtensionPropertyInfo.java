...
public final class GDExtensionPropertyInfo {
    ...
    /** Layout for field: {@snippet lang = c: GDExtensionVariantType type } */
    ...
    /** Offset for field: {@snippet lang = c: GDExtensionVariantType type } */
    public static long type$offset() {
        return type$OFFSET;
    }

    /** Getter for field: {@snippet lang = c: GDExtensionVariantType type } */
    public static int type(MemorySegment struct) {
        return struct.get(type$LAYOUT, type$OFFSET);
    }

    /** Setter for field: {@snippet lang = c: GDExtensionVariantType type } */
    ...
    /** Layout for field: {@snippet lang = c: GDExtensionStringNamePtr class_name } */
    public static AddressLayout class_name$layout() {
        return class_name$LAYOUT;
    }

    private static final long class_name$OFFSET = $LAYOUT.byteOffset(groupElement("class_name"));

    /** Offset for field: {@snippet lang = c: GDExtensionStringNamePtr class_name } */
    public static long class_name$offset() {
        return class_name$OFFSET;
    }

    /** Getter for field: {@snippet lang = c: GDExtensionStringNamePtr class_name } */
    public static MemorySegment class_name(MemorySegment struct) {
        return struct.get(class_name$LAYOUT, class_name$OFFSET);
    }

    /** Setter for field: {@snippet lang = c: GDExtensionStringNamePtr class_name } */
    ...
    /** Layout for field: {@snippet lang = c: uint32_t hint } */
    public static OfInt hint$layout() {
        return hint$LAYOUT;
    }

    private static final long hint$OFFSET = $LAYOUT.byteOffset(groupElement("hint"));

    /** Offset for field: {@snippet lang = c: uint32_t hint } */
    public static long hint$offset() {
        return hint$OFFSET;
    }

    /** Getter for field: {@snippet lang = c: uint32_t hint } */
    public static int hint(MemorySegment struct) {
        return struct.get(hint$LAYOUT, hint$OFFSET);
    }

    /** Setter for field: {@snippet lang = c: uint32_t hint } */
    ...
    /** Layout for field: {@snippet lang = c: GDExtensionStringPtr hint_string } */
    public static AddressLayout hint_string$layout() {
        return hint_string$LAYOUT;
    }

    private static final long hint_string$OFFSET = $LAYOUT.byteOffset(groupElement("hint_string"));

    /** Offset for field: {@snippet lang = c: GDExtensionStringPtr hint_string } */
    public static long hint_string$offset() {
        return hint_string$OFFSET;
    }

    /** Getter for field: {@snippet lang = c: GDExtensionStringPtr hint_string } */
    public static MemorySegment hint_string(MemorySegment struct) {
        return struct.get(hint_string$LAYOUT, hint_string$OFFSET);
    }

    /** Setter for field: {@snippet lang = c: GDExtensionStringPtr hint_string } */
    ...
    /** Layout for field: {@snippet lang = c: uint32_t usage } */
    public static OfInt usage$layout() {
        return usage$LAYOUT;
    }

    private static final long usage$OFFSET = $LAYOUT.byteOffset(groupElement("usage"));

    /** Offset for field: {@snippet lang = c: uint32_t usage } */
    public static long usage$offset() {
        return usage$OFFSET;
    }

    /** Getter for field: {@snippet lang = c: uint32_t usage } */
    public static int usage(MemorySegment struct) {
        return struct.get(usage$LAYOUT, usage$OFFSET);
    }

    /** Setter for field: {@snippet lang = c: uint32_t usage } */
