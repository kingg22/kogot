...
public final class GDExtensionPtrKeyedChecker {
    ...
    private static final FunctionDescriptor $DESC = FunctionDescriptor.of(C_INT, C_POINTER, C_POINTER);
    ...
    private static final MethodHandle UP$MH = upcallHandle(GDExtensionPtrKeyedChecker.Function.class, $DESC);
