...
/**
 * {@snippet lang = c: typedef GDExtensionBool (*GDExtensionClassSet)(GDExtensionClassInstancePtr,
...
public final class GDExtensionClassSet {
    ...
    private static final MethodHandle UP$MH = upcallHandle(GDExtensionClassSet.Function.class, $DESC);
