...
/**
 * {@snippet lang = c:
 * typedef void (*GDExtensionInterfacePrintError)(const char *, const char *, const char *, int32_t, GDExtensionBool)
 *}
 */
public final class GDExtensionInterfacePrintError {

    private GDExtensionInterfacePrintError() {
    ...
    private static final MethodHandle UP$MH = FFMUtils.upcallHandle(GDExtensionInterfacePrintError.Function.class, $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GDExtensionInterfacePrintError.Function fi, Arena arena) {
