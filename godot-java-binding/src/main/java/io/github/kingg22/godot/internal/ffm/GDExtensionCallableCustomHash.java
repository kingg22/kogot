...
public final class GDExtensionCallableCustomHash {
    ...
    private static final MethodHandle UP$MH = FFMUtils.upcallHandle(GDExtensionCallableCustomHash.Function.class, $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GDExtensionCallableCustomHash.Function fi, Arena arena) {
