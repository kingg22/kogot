...
public final class GDExtensionMainLoopCallbacks {
    ...
    private static final AddressLayout startup_func$LAYOUT = (AddressLayout) $LAYOUT.select(groupElement("startup_func"));
    ...
    private static final AddressLayout shutdown_func$LAYOUT = (AddressLayout) $LAYOUT.select(groupElement("shutdown_func"));
