...
public final class GDExtensionInterfaceVariantGetConstantValue {
    ...
    private static final FunctionDescriptor $DESC = FunctionDescriptor.ofVoid(C_INT, C_POINTER, C_POINTER);
    ...
    private static final MethodHandle UP$MH =
            upcallHandle(GDExtensionInterfaceVariantGetConstantValue.Function.class, $DESC);
