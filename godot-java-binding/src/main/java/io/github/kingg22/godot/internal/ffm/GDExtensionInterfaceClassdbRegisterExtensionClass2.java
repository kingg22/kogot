...
/**
 * {@snippet lang = c:
 * typedef void (*GDExtensionInterfaceClassdbRegisterExtensionClass2)(GDExtensionClassLibraryPtr, GDExtensionConstStringNamePtr, GDExtensionConstStringNamePtr, const GDExtensionClassCreationInfo2 *)
 *}
 *
...
public final class GDExtensionInterfaceClassdbRegisterExtensionClass2 {
    ...
    private static final MethodHandle UP$MH = FFMUtils.upcallHandle(GDExtensionInterfaceClassdbRegisterExtensionClass2.Function.class, $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GDExtensionInterfaceClassdbRegisterExtensionClass2.Function fi, Arena arena) {
