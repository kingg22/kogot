...
public final class GDExtensionInterfaceVariantGetPtrBuiltinMethod {
    ...
    private static final FunctionDescriptor $DESC = FunctionDescriptor.of(C_POINTER, C_INT, C_POINTER, C_LONG);
    ...
    private static final MethodHandle UP$MH =
            upcallHandle(GDExtensionInterfaceVariantGetPtrBuiltinMethod.Function.class, $DESC);
