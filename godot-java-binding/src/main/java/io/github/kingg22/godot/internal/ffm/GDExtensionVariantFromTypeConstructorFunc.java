...
public final class GDExtensionVariantFromTypeConstructorFunc {
    ...
    private static final MethodHandle UP$MH = FFMUtils.upcallHandle(GDExtensionVariantFromTypeConstructorFunc.Function.class, $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GDExtensionVariantFromTypeConstructorFunc.Function fi, Arena arena) {
