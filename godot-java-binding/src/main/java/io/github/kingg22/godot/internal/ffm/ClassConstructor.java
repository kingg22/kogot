...
public final class ClassConstructor {
    ...
    private static final MethodHandle UP$MH = upcallHandle(ClassConstructor.Function.class, $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}. The lifetime of the returned segment
     * is managed by {@code arena}
     */
    public static MemorySegment allocate(ClassConstructor.Function fi, Arena arena) {
