...
/**
 * {@snippet lang = c: typedef GDExtensionPtrDestructor
 * (*GDExtensionInterfaceVariantGetPtrDestructor)(GDExtensionVariantType) }
 */
public final class GDExtensionInterfaceVariantGetPtrDestructor {

    private GDExtensionInterfaceVariantGetPtrDestructor() {
    ...
    private static final MethodHandle UP$MH =
            upcallHandle(GDExtensionInterfaceVariantGetPtrDestructor.Function.class, $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}. The lifetime of the returned segment
     * is managed by {@code arena}
     */
    public static MemorySegment allocate(GDExtensionInterfaceVariantGetPtrDestructor.Function fi, Arena arena) {
