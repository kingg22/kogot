...
public final class GDExtensionCallableCustomToString {
    ...
    private static final MethodHandle UP$MH = FFMUtils.upcallHandle(GDExtensionCallableCustomToString.Function.class, $DESC);
     ...
     */
    public static void invoke(MemorySegment funcPtr, MemorySegment callable_userdata, MemorySegment r_is_valid, MemorySegment r_out) {
        try {
            DOWN$MH.invokeExact(funcPtr, callable_userdata, r_is_valid, r_out);
