...
public final class GDExtensionInterfaceClassdbGetMethodBind {
    ...
    private GDExtensionInterfaceClassdbGetMethodBind() {
    ...
    private static final FunctionDescriptor $DESC = FunctionDescriptor.of(C_POINTER, C_POINTER, C_POINTER, C_LONG);
    ...
    private static final MethodHandle UP$MH =
            upcallHandle(GDExtensionInterfaceClassdbGetMethodBind.Function.class, $DESC);
