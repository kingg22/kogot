...
public final class GDExtensionInterfaceGetLibraryPath {
    ...
    private GDExtensionInterfaceGetLibraryPath() {
    ...
    private static final MethodHandle UP$MH = FFMUtils.upcallHandle(GDExtensionInterfaceGetLibraryPath.Function.class, $DESC);
