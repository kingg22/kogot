...
/**
 * {@snippet lang = c:
 * typedef void *(*GDExtensionClassGetVirtualCallData)(void *, GDExtensionConstStringNamePtr)
 *}
 *
 * @deprecated Use GDExtensionClassGetVirtualCallData2 instead
 */
@Deprecated
public final class GDExtensionClassGetVirtualCallData {
    ...
    private static final MethodHandle UP$MH = FFMUtils.upcallHandle(GDExtensionClassGetVirtualCallData.Function.class, $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GDExtensionClassGetVirtualCallData.Function fi, Arena arena) {
