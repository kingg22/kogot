package io.github.kingg22.godot.codegen.models.extensioninterface
...
sealed class Types {
    ...
    @Serializable
    @SerialName("alias")
    data class AliasType(override val name: String, val type: String) : Types()

    @Serializable
    @SerialName("struct")
    data class StructType(override val name: String, val members: List<Member>) : Types()
