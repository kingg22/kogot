 ...
 * [io.github.kingg22.godot.codegen.models.extensionapi.EnumDescriptor.values] and the list returned by [getAllConstantsNames] is always maintained.
 *
 ...
 *
 * - **Default values**
 *   ([io.github.kingg22.godot.codegen.extensionapi.impl.knative.generators.DefaultValueGenerator.parseEnumFromValue])
...
class EnumConstantResolver(
     ...
     *
     * The returned list has exactly the same size as [io.github.kingg22.godot.codegen.models.extensionapi.EnumDescriptor.values], so it can be safely
